      ...
      >
        ...
        >
          <svg
            ...
            className="jsx-158e4b8c7d0d29f7 mx-auto block h-[60px] "
          >
            <path
          ...
          <div className="border-l-[2px] border-gray  pl-10 flex items-center space-x-3">
            <img
              onClick={() => navigate("/")}
              className="w-12"
              ...
              alt=""
            />
            <p className="title text-pinkTheme">
              Đặt vé <br /> xem phim
            </p>
          </div>
        </div>

        <div className="flex justify-around items-center space-x-5 text-lg font-600">
