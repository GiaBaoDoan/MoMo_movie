    ...
    <HeaderS className="max-lg:p-10 p-5">
      <section>
        ...
        >
          <div
            onClick={() => navigate("/")}
            className="flex items-center cursor-pointer space-x-3 max-sm:space-x-2  max-lg:space-x-1"
          >
            <div>
              <svg
                width="72"
                ...
                className="jsx-158e4b8c7d0d29f7 block h-[60px] max-sm:h-[40px] max-lg:h-[50px]"
              >
                <path
            ...
            <div className=" space-x-3 max-sm:space-x-1 flex-1 flex items-center">
              <img
                onClick={() => navigate("/")}
                className="w-12 max-lg:w-9"
                src="https://homepage.momocdn.net/fileuploads/svg/momo-file-221117104714.svg"
                alt=""
              />
              <p className="title text-base text-pinkTheme max-sm:text-sm">
                Đặt vé <br /> xem phim
              </p>
            </div>
          </div>
