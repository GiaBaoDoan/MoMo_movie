  ...
  return (
    <footer className="text-lg text-white">
      ...
      <div className="bg-[rgba(38,38,38,1)] py-5 h-full">
        <div className="copy-right w-[90%] mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <svg
              ...
              className="jsx-158e4b8c7d0d29f7 block h-[60px] "
            >
              <path
          ...
          <div>
            <p className="text-opacity-50 text-white font-medium">
